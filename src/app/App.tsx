            ...
            <div className="flex-1 w-full max-w-[400px] flex flex-col items-center pt-8 pb-20 px-4 relative">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    '0 18px 40px rgba(0,0,0,0.22), 0 6px 15px rgba(0,0,0,0.15), 0 -1px 3px rgba(255,255,255,0.8), inset 0 0 18px rgba(0,0,0,0.12), inset 0 8px 12px rgba(255,255,255,1), inset 0 -15px 30px rgba(0,0,0,0.24), inset 15px 0 25px rgba(0,0,0,0.08), inset -15px 0 25px rgba(0,0,0,0.08)',
                ...
                <div className="flex items-center justify-center gap-1.5 w-full px-2 py-1">
                  <span
                    ...
                    style={{
                      color: '#22c55e',
                      textShadow:
                        '1px 1px 0px #16a34a, 2px 2px 0px #15803d, 2px 2px 4px rgba(0,0,0,0.5)',
                    }}
                  >
                    NEXT
                  </span>
