...
| **v3.5.0** | 2026-06-09 | Penambahan spesifikasi desain Channel Manage Panel & Moderation Panel kustom bertema light modal dengan 4 tab yang dioptimalkan muat penuh tanpa terpotong (Seksi 4 di `DESIGN_SPEC_MODALS_PANELS.md`). | Senior System Architect |
